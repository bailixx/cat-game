...
# 网站url https://cat-game.streamlit.app/

一个基于浏览器运行的 3D 虚拟宠物互动引擎。本项目打破了常规的网页交互限制，将Three.js的3D渲染与MediaPipe的计算机视觉（CV）手势追踪技术完美融合，打造了一个可以通过滑动屏幕、点击和真实手势喂食的沉浸式 AI 互动体验 。
